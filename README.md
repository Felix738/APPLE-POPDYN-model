...
- `scripts/sensitivity analysis simple.R`: R script for a simple sensitivity analysis of a few exemplary parameters of the APPLE-POPDYN model
...
**Sauke, F., Meyer, K., Pincebourde, S., Wiegand, K.** (2025). *Dataset: Raw Data, Processed Data, Processing Scripts, and Results of the APPLE-POPDYN Model*.
